...
module.exports = function(service, accessory) {
    ...
    let options = [
...

        {
            ...
            get: async function(option) {
                if (!await Remote.getPower()) return false;
...

        {
            ...
            get: async function(option) {
                ...
                let input = await Remote.getInputSource();
...

        {
            ...
            get: async function(option) {
                ...
                let picture_mode = await Remote.getPictureMode();
                return picture_mode.value == option.value;
            },
