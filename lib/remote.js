...
module.exports = class Remote {
    ...
    init() {
        ...
        this.art = method === MethodFrame ? new Art(this.device) : null;
    ...
    async _turnOn() {
        ...
        return this.api.setActiveOn().then(() => {
    ...
    async _turnOff() {
        ...
        return this.api.setActiveOff().then(() => {
