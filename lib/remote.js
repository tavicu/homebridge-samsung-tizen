...
module.exports = class Remote {
    ...
    async getPower() {
        if (this.turningOn !== null || this.turningOff !== null) {
    ...
    async _turnOn(options) {
        ...
        if (active && this.standbyMode === null) {
            return;
        }
        ...
        return this.api.setStateOn().then(() => {
            this.turningOn = setTimeout(() => {
                this.turningOn = null;
                this._confirmTargetState();
            }, TURNING_TIMEOUT);
    ...
    async _turnOff(options) {
        ...
        if (this.turningOn !== null || this.turningOff !== null || this.standbyMode !== null) {
            return;
        }
