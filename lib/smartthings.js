...
module.exports = class SmartThings {
    ...
    setInputSource(value) {
        const capability = ["PC", "USB-C", "Display Port"].includes(value) ? 'samsungvd.mediaInputSource' : 'mediaInputSource';

        return this.sendCommands({component: 'main', capability: capability, command: 'setInputSource', arguments: [value]});
    }
