...
module.exports = class Switch {
    constructor(config, device, homebridge) {
        Platform   = homebridge.platform;
        ...
        this.platformAccessory = Platform.cachedAccessories.find(cachedAccessory => cachedAccessory.UUID == this.UUID) || new Homebridge.platformAccessory(this.config.name, this.UUID);
