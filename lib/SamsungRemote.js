...
module.exports = class SamsungRemote {
    ...
    constructor(config) {
        ...
        this.sleep      = null;
        this.remote     = `wss://${this.ip}:${this.port}/api/v2/`;
    ...
    _connection() {
        return new Promise(async (resolve, reject) => {
            ...
            // Start connection
            this.socket = new WebSocket(this.remote + `channels/samsung.remote.control?name=${this._encodeName()}&token=${this.token}`, {
    ...
    _pair() {
        return new Promise((resolve, reject) => {
            // Start connection
            let socket = new WebSocket(this.remote + `channels/samsung.remote.control?name=${this._encodeName()}`, {
                rejectUnauthorized: false
            });
