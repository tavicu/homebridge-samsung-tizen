...
module.exports = class SamsungRemote {
    ...
    isOn(getRealStatus = false) {
        return new Promise(resolve => {
            // If TV is sleep mode
            if (this.sleepMode !== null && !getRealStatus) {
                resolve(false);
            }
    ...
    turnOn() {
        return new Promise(async (resolve, reject) => {
            ...
            if (status) {
                ...
                this.turningOn = setTimeout(() => { this.turningOn = null; }, 1000 * 4);

                return resolve(this.log('TV successfully powered ON (CMD)'));
            } else {
                ...
                wol.wake(this.mac, (error) => {
                    if (error) {
                        ...
                        return resolve(this.log('TV successfully powered ON (WOL)'));
                    }
                });
            }
        });
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (!status) {
                ...
                try {
                    ...
                    this.turningOff = setTimeout(() => { this.turningOff = null; }, 1000 * 4);
