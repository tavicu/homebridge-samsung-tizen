...
import { TelevisionService, SpeakerService, InformationService, InputService } from '../services';
...
export class TelevisionAccessory {
    ...
    constructor(public device: Device, public platform: SamsungPlatform) {
        const { api } = platform;
    ...
    private getServices() {
        return [
            ...Object.values(this.services).map((type: any) => type.service),
            ...Object.values(this.inputs).map((type: any) => type.service),
        ].flat();
    }
